...
- positions.closed and positions.closing_date are NOT currently used: should we drop them ? by deciding to keep ( and maintain ! ) those fields we could get rid of the related computation logic
